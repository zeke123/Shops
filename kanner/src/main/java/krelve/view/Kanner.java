...
public class Kanner extends FrameLayout {
    ...
    private void initLayout() {
        ...
        //SpeedUtils.controlViewPagerSpeed(context, vp, 1000);//设置你想要的时间
    ...
    private void initImgFromNet(String[] imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            // mImageLoader.displayImage(imagesUrl[count - 1], iv, options);
                ...
                Bitmap bm = BitmapFactory.decodeFile(imagesUrl[count - 1], options);
                ...
                BitmapFactory.Options options = new BitmapFactory.Options();
                options.inSampleSize = 4;
                Bitmap bm = BitmapFactory.decodeFile(imagesUrl[0], options);
                iv.setImageBitmap(bm);
               ...
               // mImageLoader.displayImage(imagesUrl[i - 1], iv, options);
                ...
                BitmapFactory.Options options = new BitmapFactory.Options();
                options.inSampleSize = 4;
                Bitmap bm = BitmapFactory.decodeFile(imagesUrl[i-1], options);
                iv.setImageBitmap(bm);
